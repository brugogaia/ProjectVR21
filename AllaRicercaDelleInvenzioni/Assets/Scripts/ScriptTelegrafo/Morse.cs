...
public class Morse : MonoBehaviour
{
    ...
    private List<KeyCode> risposta=new List<KeyCode>{KeyCode.Alpha5, KeyCode.KeypadPlus, KeyCode.Alpha7};
    private List<KeyCode> rispostaPad=new List<KeyCode>{KeyCode.Keypad5, KeyCode.KeypadPlus, KeyCode.Keypad7};
    private List<KeyCode> risposta2=new List<KeyCode>{KeyCode.Alpha9, KeyCode.KeypadMinus, KeyCode.Alpha3};
